...
module.exports = {
    VERSION: 'v3.0.0',
    CHANNEL: 'undefined',
    SESSION: process.env.ABU_CODE === undefined ? 'apikey' : process.env.ABU_CODE,
    ...
    NBSK: process.env.ALL_NUMBER === undefined ? '917025994178' : process.env.ALL_NUMBER,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐀𝐁𝐔𝐒𝐄𝐑¹¹:𝐉𝐀𝐒𝐈𝐋;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/jasil_xo' : process.env.IG,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'Aʙᴜsᴇʀ¹¹|ᴀʙᴜsᴇʀ' : process.env.STICKER_DATA,
    ...
    ST:"https://gist.github.com/Afx-Abu/",
